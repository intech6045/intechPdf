...
static INT_PTR CALLBACK Dialog_PdfAssociate_Proc(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    if (WM_INITDIALOG == msg)
    {
        ...
        SetDlgItemText(hDlg, IDC_STATIC, _TR("Make ZeroView default application for PDF files?"));
...
static INT_PTR CALLBACK Dialog_NewVersion_Proc(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    if (WM_INITDIALOG == msg)
    {
        ...
        assert(NULL != data);
        SetWindowLongPtr(hDlg, GWLP_USERDATA, (LONG_PTR)data);
        win::SetText(hDlg, _TR("ZeroView Update"));
...
static INT_PTR CALLBACK Dialog_Settings_Proc(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_INITDIALOG:
        ...
        if (IsExeAssociatedWithPdfExtension()) {
            SetDlgItemText(hDlg, IDC_SET_DEFAULT_READER, _TR("ZeroView is your default PDF reader"));
            ...
            SetDlgItemText(hDlg, IDC_SET_DEFAULT_READER, _TR("Make ZeroView my default PDF reader"));
            EnableWindow(GetDlgItem(hDlg, IDC_SET_DEFAULT_READER), HasPermission(Perm_RegistryAccess));
        }

        win::SetText(hDlg, _TR("ZeroView Options"));
    ...
    case WM_COMMAND:
        ...
        case IDC_SET_DEFAULT_READER:
            ...
            if (IsExeAssociatedWithPdfExtension()) {
                ...
                SetDlgItemText(hDlg, IDC_SET_DEFAULT_READER, _TR("ZeroView should now be your default PDF reader"));
            }
            return TRUE;
        }
        break;
