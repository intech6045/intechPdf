...
#define FRAME_CLASS_NAME        L"ZERO_VIEW_FRAME"
#define SUMATRA_WINDOW_TITLE    L"Å×½ºÆ® ºä¾î"

#define WEBSITE_MAIN_URL         L"http://www.ZeroView.com/"
#define WEBSITE_MANUAL_URL       L"http://www.ZeroView.com/manual"
...
void MyloadDocument(WindowInfo *win, WCHAR *wFileName);//2020-06-03
