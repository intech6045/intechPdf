...
#define TOOLBAR_MIN_ICON_SIZE 56
...
static void CreateFindBox(WindowInfo& win)
{
	...
	HWND findBg = CreateWindowEx(WS_EX_CLIENTEDGE, WC_STATIC, L"", WS_VISIBLE | WS_CHILD,
		0, 1, (int)(100 * win.uiDPIFactor), (int)(25 * win.uiDPIFactor + 4),
		win.hwndToolbar, (HMENU)0, ghinst, NULL);
	...
	HWND find = CreateWindowEx(0, WC_EDIT, L"", WS_VISIBLE | WS_CHILD | ES_AUTOHSCROLL,
		0, 1, (int)(100 * win.uiDPIFactor - 2 * GetSystemMetrics(SM_CXEDGE)), (int)(25 * win.uiDPIFactor + 2),
		win.hwndToolbar, (HMENU)0, ghinst, NULL);
...
void UpdateToolbarPageText(WindowInfo *win, int pageCount, bool updateOnly)
{
    ...
    MoveWindow(win->hwndPageBox, pos_x + size.dx + padding, (pageWndRect.dy - size.dy + 1) / 2 + pos_y,  pageWndRect.dx - 2 * padding, size.dy, FALSE);
...
static void CreatePageBox(WindowInfo& win)
{
    ...
    //                        win.hwndToolbar, (HMENU)0, ghinst, NULL);
	//2020-06-18
	HWND pageBg = CreateWindowEx(WS_EX_CLIENTEDGE, WC_STATIC, L"", WS_VISIBLE | WS_CHILD,
		0, 1, (int)(PAGE_BOX_WIDTH * win.uiDPIFactor), (int)(25 * win.uiDPIFactor + 4),
		win.hwndToolbar, (HMENU)0, ghinst, NULL);
	//2020-06-18
    ...
    //                        win.hwndToolbar, (HMENU)0, ghinst, NULL);
	HWND page = CreateWindowEx(0, WC_EDIT, L"0", WS_VISIBLE | WS_CHILD | ES_AUTOHSCROLL | ES_NUMBER | ES_RIGHT,
		0, 1, (int)(PAGE_BOX_WIDTH * win.uiDPIFactor - 2 * GetSystemMetrics(SM_CXEDGE)), (int)(25 * win.uiDPIFactor + 2),
		win.hwndToolbar, (HMENU)0, ghinst, NULL);
...
void CreateToolbar(WindowInfo *win)
{
    ...
    HBITMAP hbmp = LoadExternalBitmap(ghinst, L"toolbar_56.bmp", IDB_TOOLBAR56);
    ...
    rbBand.cyMinChild = (rc.bottom - rc.top) + 2 * rc.top; //2020-06-18
    rbBand.cx         = 0;
