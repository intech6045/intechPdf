...
#define ABOUT_WIN_TITLE         _TR("About ZeroView")
...
static AboutLayoutInfoEl gAboutLayoutInfo[] = {
    { L"website",        L"ZeroView website",   WEBSITE_MAIN_URL},
	{ L"created by",     L"Amnis Technology Ltd.",L"http://www.amnistechnology.com/" },
    { L"manual",         L"ZeroView manual",    WEBSITE_MANUAL_URL },
    { L"based on",       L"SumatraPDF",        L"http://blog.kowalczyk.info/software/sumatrapdf/" },
#ifdef SVN_PRE_RELEASE_VER
...
void OnMenuAbout()
{
    ...
    if (!gAtomAbout) {
        ...
        wcex.hIcon = LoadIcon(ghinst, MAKEINTRESOURCE(IDI_CERTPIA));
